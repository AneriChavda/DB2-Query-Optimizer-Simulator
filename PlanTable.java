public class PlanTable {
	...
	public char indexOnly = 'Y'; // 'Y' if index only access
	...
	public enum AccessType {
		TABLESPACE_SCAN('R'), INDEX_SCAN('I'), IN_LIST_INDEX_SCAN('N');
		private char val;
	...
	public void printTable(DbmsPrinter out) {
		String accName = accessName.trim();
		out.println("--------------------------------------------------------------------------------------------------------------");
		...
		out.println("--------------------------------------------------------------------------------------------------------------");
		out.println(String.format("%-20s %-20s %-15s", "| AccessName ", "| " + 	accName.replace(".", ""), "| Name of index file if ACCESSTYPE is I or N "));
		out.println("--------------------------------------------------------------------------------------------------------------");
